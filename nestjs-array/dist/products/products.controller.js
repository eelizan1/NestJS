...
let ProductsController = class ProductsController {
    ...
    addProduct(prodTitle, prodDesc, prodPrice) {
        const generatedId = this.productServce.insertProduct(prodTitle, prodDesc, prodPrice);
    ...
    updateProduct(prodId, prodTitle, prodDesc, prodPrice) {
        return this.productServce.updateProduct(prodId, prodTitle, prodDesc, prodPrice);
    }
